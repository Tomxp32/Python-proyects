clase_1 = '''
	...
	establecidas, tales como teoremas o bien las afirmaciones iniciales o axiomas.2​ En principio una 
	...
	Clase: Cuantificadores logicos #2
		...
		* Usaando implicaciones: El cubo de todos loe enteros negativos es negativo.
		...
		En el caso anterior estamos demostrando a traves de un contrajemplo que eso no es verdadero, es 
		falso. Este metodo se utiliza cuando algo se toma por verdadero. 
		...
		Esto es un taller para la siguiente clase. Buscar 4 demostraciones 1 de cada tema explicarlas 
		y ubicar el teorema
