clase_1 = '''
	...
	Clase: Cuantificadores logicos #2
		...
		* Usaando implicaciones: El cubo de todos loe enteros negativos es negativo.
		...
		En el caso anterior estamos demostrando a traves de un contrajemplo que eso no es verdadero, es falso. Este metodo se utiliza cuando algo se toma por verdadero. 
